...
# Студенты
student_1 = Student('Антон', 'Викторович', 'Муж')
student_1.courses_in_progress += ['Python']
student_1.finished_courses += ["Введение в програмирование"]

student_2 = Student('Светлана', 'Андреевна', 'Жен')
student_2.courses_in_progress += ['Python']
student_2.finished_courses += ["Введение в програмирование"]

# Лекторы
lecturer_1 = Lecturer('Олег', 'Васильевич')
lecturer_1.courses_attached += ['Python']

lecturer_2 = Lecturer('Ирина', 'Захарова')
lecturer_2.courses_attached += ['Python']

# Проверяющие
reviewer_1 = Reviewer('Сергей', 'Иванович')
reviewer_1.courses_attached += ['Python']

reviewer_2 = Reviewer('Ольга', 'Владимировна')
...
student_2.rate_lw(lecturer_2, 'Python', 3)
...
print('\nCредняя оценка за лекции всех лекторов:')
